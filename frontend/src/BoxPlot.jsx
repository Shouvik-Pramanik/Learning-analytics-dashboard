...
const App = () => {
  ...
  if (users && users.length > 0) {
    ...
    // Sort the T1 values in ascending order
    ...
    // Extract T2 values from the users array
    const t2Values = users.map(user => user.T2);

    // Sort the T2 values in ascending order
    ...
    // Sort the T3 values in ascending order
    ...
    // Assign calculated values to box plot dataPoints
    options.data.push({
      type: 'boxAndWhisker',
