...
const BatchAnalytics = (props) => {
  ...
  let filteredUsers = users.filter((user) => user.Batch === selectedBatch);

  // Sort users by T3 marks (highest to lowest)
  ...
  // Calculate statistics for T1, T2, and T3
    ...
    >
      ...
      {selectedBatch && (
        <div style={{ marginTop: "20px" }} className="main-batch">
          <h3 style={{ marginBottom: "12px" }}>Users in {selectedBatch}:</h3>
